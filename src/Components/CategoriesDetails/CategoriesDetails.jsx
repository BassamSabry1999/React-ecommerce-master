...
export default function Categories() {
    ...
    async function getData() {
        setLoading(true)
        let api = await axios.get('https://route-ecommerce.onrender.com/api/v1/products?category[in][]='+localStorage.getItem('categoryId'))
      ...
      {Loading ?
        ...
        : 
          ...
          <div className="container mt-5">
            <h1 className='mb-5'>{localStorage.getItem('categoryName')}</h1>
            <div className="row">
              {Api.map((prod) => {
